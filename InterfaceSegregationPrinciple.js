...
var AllInOnePrinter = /** @class */ (function () {
    ...
    AllInOnePrinter.prototype.print = function (model, price) { return "Device model is " + model + ", and it's price " + price; };
    AllInOnePrinter.prototype.fax = function () { return "Sorry, I cant fax"; };
    AllInOnePrinter.prototype.scan = function () { return "Sorry, I cant scan"; };
...
var EconomicPrinter = /** @class */ (function () {
    ...
    EconomicPrinter.prototype.print = function (model, price) { return "Device model is " + model + ", and it's price " + price; };
